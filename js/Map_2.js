...
function mapMouseDown(evt)
{
	...
	switch(CMD)
	{
		...
		case "PAN"://漫游
			//addGraphicUnit1();
		    if(minAmp==currentAmp) {alert("请先放大地图...");  CMD = null; map.removeChild(node);  break;}
		    panX=evt.clientX;
	        panY=evt.clientY;
	        isBusy=true;
		    break;
...
function fullscreen()
{ Map.setAttribute("cursor","default"); 
	CMD = null;
